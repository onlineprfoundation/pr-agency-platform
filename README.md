...
A self-hosted Laravel application for PR agencies. Deploy via cPanel using the included build script. Manage clients, businesses, projects, publications, invoicing, and a client portal—all configurable via admin settings. Distribution-ready with web installer, Stripe, SMTP, and optional reCAPTCHA.
