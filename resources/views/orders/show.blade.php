    ...
    <div class="py-16">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 space-y-6">
                <h1 class="text-xl font-bold text-gray-900">Order: {{ $order->package->name }}</h1>
                ...
                @if($order->canSubmit())
                <form method="POST" action="{{ route('orders.submit', $order->access_token) }}" enctype="multipart/form-data" class="space-y-4">
                    @csrf
                    <div>
