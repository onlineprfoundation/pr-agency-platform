    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    @if($orders->isEmpty())
                        <p class="text-gray-500 text-center py-12">You have no publication orders yet. <a href="{{ route('publications.index') }}" class="text-gray-800 hover:underline font-medium">Browse publications</a> to get started.</p>
                    @else
                        <div class="space-y-4">
                                ...
                                <a href="{{ route('portal.publication-orders.show', $order) }}" class="block p-4 rounded-lg border border-gray-200 hover:bg-gray-50 transition">
                                    <div class="flex justify-between items-start">
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-500 mt-1">{{ ucfirst(str_replace('_', ' ', $order->status)) }} · {{ $order->source === 'quote_request' ? 'Quote' : 'Purchase' }}</p>
